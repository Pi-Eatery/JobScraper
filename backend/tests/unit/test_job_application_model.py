...
def test_get_job_application_by_id(db_session):
    ...
    found_application = db_session.query(JobApplication).filter(JobApplication.id == new_application.id).first()
...
def test_update_job_application(db_session):
    ...
    updated_application = db_session.query(JobApplication).filter(JobApplication.id == new_application.id).first()
